 ...
 */
public class RoundLinear extends LinearLayout implements RoundAble {
    ...
    public RoundLinear(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundLinear(Context context, AttributeSet attrs, int defStyleAttr) {
